...
public class MainUrtNIP extends InputVariable {
	...
	public  static void main(String[]args) {
		...
		obj.queryMenampilkanJumlahPNSberdasrkanAgamadanGolongan();
...
>>>>>>> e4e6dbdc405f20adcc3477f29da4b838596303e9
			}
			space=(String) obj.get(fieldd);
			System.out.print("|"+space);
>>>>>>> origin/modeling
...
<<<<<<< HEAD
	...
	public  void getMenampilkanJumlahPNSberdasrkanAgamadanGolongan(){ //modify by siska
		UrtNIP urtNIP = new UrtNIP();
		JSONArray data = urtNIP.queryMenampilkanJumlahPNSberdasrkanAgamadanGolongan(0);
		showData2Parameter(data,"agama","golongan","jumlah_pns");
	}

	public  void showData2Parameter(JSONArray arrayData,String fielda, String fieldb, String fieldc) {
		//System.out.println(arrayData);
		System.out.println("+------------------------------------------------------------------------+");
		System.out.println("|        Agama       |        Golongan      |          Jumlah_PNS        |");
		System.out.println("+------------------------------------------------------------------------+");
		String space;
		long tmp;
